...
public class EjectBallAutomationCmd extends ParallelCommandGroup {
  public EjectBallAutomationCmd(IntakeRollersSub intakeRollers, ConveyanceRollerSub rollers) {
