...
import frc.robot.commands.ResetPositionCommand.ResetByStallCmd;
...
public class ResetSubsystemsAutomationCmd extends ParallelCommandGroup {
  public ResetSubsystemsAutomationCmd(HoodSUB hood, IntakeSub intake) {
    ...
    addCommands(
        new ResetByStallCmd(hood,hood::setSpeed,hood::stop, hood::resetPosition,hood::isStalling, -0.2),
        new ResetByStallCmd(intake,intake::SetMotor,intake::stop, intake::resetPosition,intake::isStalling, -3),
