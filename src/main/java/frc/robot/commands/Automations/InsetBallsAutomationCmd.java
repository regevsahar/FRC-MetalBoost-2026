...
public class InsetBallsAutomationCmd extends ParallelCommandGroup {
  public InsetBallsAutomationCmd(
      IntakeSub intakeMovement, IntakeRollersSub rollers) {

    addCommands(
        new OpenIntakeCmd(intakeMovement),
        new RollToInsertBallsCmd(rollers),
        new FunctionalCommand(
            () -> LedController.getInstance().startGradient(
                Color.kYellow, Color.kLightYellow),
            () -> {},
