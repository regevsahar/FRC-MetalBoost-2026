...
public class TeleopSwerve extends Command {    
    ...
    public TeleopSwerve(Swerve s_Swerve, DoubleSupplier translationSup, DoubleSupplier strafeSup, DoubleSupplier rotationSup, BooleanSupplier robotCentricSup, DoubleSupplier speedReductionSup) {
        this.s_Swerve = s_Swerve;
        addRequirements(s_Swerve);
    ...
    public void execute() {
        ...
        double rotationVal = MathUtil.applyDeadband(rotationSup.getAsDouble() * speedReductionSup.getAsDouble(), Constants.stickDeadband);
