...
public class Swerve extends SubsystemBase {
    ...
    public Swerve(PoseEstimator estimator) {
        ...
        swerveOdometry = new SwerveDriveOdometry(Constants.SwerveConstants.swerveKinematics, getGyroYaw(),
                getModulePositions());
    ...
    public void driveRobotRelative(ChassisSpeeds speeds) {
        ...
        SwerveModuleState[] swerveModuleStates = Constants.SwerveConstants.swerveKinematics
    ...
    public void periodic() {
        ...
        for (SwerveModule mod : mSwerveMods) {
            ...
            Logger.recordOutput("Estimator/Mods/Mod " + mod.moduleNumber + " Integrated",
                    mod.getPosition().angle.getDegrees());
            Logger.recordOutput("Estimator/Mods/Mod " + mod.moduleNumber + " Velocity",
