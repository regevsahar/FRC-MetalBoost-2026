package frc.robot.subsystems.Swerve.Configs;
...
public final class CTREConfigs {
    ...
    public CTREConfigs() {
        ...
        swerveAngleFXConfig.CurrentLimits.SupplyCurrentLowerLimit = Constants.SwerveConstants.angleCurrentThreshold;
        swerveAngleFXConfig.CurrentLimits.SupplyCurrentLowerTime = Constants.SwerveConstants.angleCurrentThresholdTime;
        ...
        swerveDriveFXConfig.CurrentLimits.SupplyCurrentLowerLimit = Constants.SwerveConstants.driveCurrentThreshold;
        swerveDriveFXConfig.CurrentLimits.SupplyCurrentLowerTime = Constants.SwerveConstants.driveCurrentThresholdTime;
