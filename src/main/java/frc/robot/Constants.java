...
public final class Constants {
    ...
    public static final class SwerveConstants {
        ...
        public static final PathConstraints constraints = new PathConstraints(
                ...
                LinearAcceleration.ofBaseUnits(Constants.SwerveConstants.maxAcceleration, MetersPerSecondPerSecond),
                AngularVelocity.ofBaseUnits(Constants.SwerveConstants.maxAngularVelocity, RadiansPerSecond),
                AngularAcceleration.ofBaseUnits(Constants.SwerveConstants.maxAngularAcceleration,
        ...
        public static final class Mod0 { // TODO: This must be tuned to specific robot
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(-69.24);
        ...
        public static final class Mod1 { // TODO: This must be tuned to specific robot
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(-101.6);
            public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID, angleMotorID,
                    canCoderID, angleOffset);
        }
        ...
        public static final class Mod2 { // TODO: This must be tuned to specific robot
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(-1.31);
            public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID, angleMotorID,
                    canCoderID, angleOffset);
        }
        ...
        public static final class Mod3 { // TODO: This must be tuned to specific robot
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(-102.12);
            public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID, angleMotorID,
                    canCoderID, angleOffset);
        }
    }
    ...
    public static final class PoseEstimator {
        ...
        public static final double stdDevFactorTranslation = 0.0035;
        public static final double stdDevFactorRotation = 0.05;    
        public static final double minimumStdDev = 0.01;
    }

    public static final class FieldConstants {
        public static final Translation2d HUB_CENTER_RED = new Translation2d(0.0, 0.0); // TODO: Update coordinates
        public static final Translation2d HUB_CENTER_BLUE = new Translation2d(4.62534, 4.03); // TODO: Update
                                                                                              // coordinates
