...
public class RobotContainer {
        ...
        public final LimelightSubsystem limelight = new LimelightSubsystem(CameraConstants.limelight3name);
        public final LimelightSubsystem limelight2 = new LimelightSubsystem(CameraConstants.limelight4name);
