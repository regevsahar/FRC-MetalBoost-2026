...
public class RobotContainer {
    ...
    /* operation Buttons */
    private final Trigger shoot = new Trigger(() -> operator.getRawAxis(XboxController.Axis.kRightTrigger.value) > 0.1);
    private final JoystickButton spin = new JoystickButton(operator, XboxController.Button.kLeftBumper.value);
    private final JoystickButton spinAnotherSide = new JoystickButton(operator,
            XboxController.Button.kRightBumper.value);
