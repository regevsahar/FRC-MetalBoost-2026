...
public class ShotPrediction {
     ...
     * speeds, and flight time.
     * futurePos = currentPos + (vx, vy) * flightTime
     */
    public static Translation2d predictFuturePosition(Pose2d currentPose, ChassisSpeeds fieldRelativeSpeeds,
            double flightTime) {
     ...
     * position.
     * desiredYaw = atan2(hubY - futureY, hubX - futureX)
     */
    public static Rotation2d calculateDesiredYaw(Translation2d futurePosition, Translation2d hubPosition) {
