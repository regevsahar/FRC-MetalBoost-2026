 ...
 *
 * <p>
 * The grid is indexed from the <b>bottom-left</b> corner of the field:
 * <ul>
 *   <li>Row 0 corresponds to the bottom of the field</li>
 *   <li>Column 0 corresponds to the left side of the field</li>
 * </ul>
 *
 * <p>
 * Each grid cell represents a square area of {@code nodeSizeMeters × nodeSizeMeters}.
 * A value of {@code true} indicates a blocked / red / forbidden cell.
 *
 * <p>
 * All conversions from world coordinates (meters) to grid indices use
 * {@link Math#floor(double)} to ensure consistent indexing.
 */
public class GridMap {
    ...
    /**
     * Converts field coordinates in meters to grid indices.
     * The conversion uses {@link Math#floor(double)} for both axes.
     *
    ...
    /**
     * Converts a grid index back to a {@link Pose2d} located at the
    ...
    public boolean isInsideGrid(GridIndex index) {
        return index.row() >= 0 && index.row() < rows
