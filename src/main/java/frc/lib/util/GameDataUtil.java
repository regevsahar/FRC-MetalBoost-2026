...
public class GameDataUtil {
    ...
    /**
     * Returns true when the hub is currently inactive but will activate within 3
     * seconds. Use this to
    ...
    /**
     * Returns true exactly once each time the game shifts to a new phase. Should be
     * polled
    ...
    /**
     * Publishes match timer and game-state information to SmartDashboard for the
     * Elastic dashboard.
    ...
    /**
     * Computes whether the hub is active at a given match time remaining, given the
     * shift state.
     */
