...
public class Boundaries {
  ...
  /**
   * This function uses the deadband and checks all the variables passed. If ANY are true it returns
   * true.
   *
  ...
  /**
   * This function uses the deadband and checks all the variables passed. If ALL are true it returns
   * true.
   *
   * @param deadband minimum value
   * @param vars the varables to see if they past the deadband
