...
public class ToleranceMath {
  ...
  public static boolean isAtPose(
      ...
      Pose2d tolerances,
      Pose2d deadbands) {
    return isNear(targetPose, currentPose, tolerances)
        && SwerveMath.isStill(currentSpeeds, deadbands);
  }
  ...
  public static boolean isNear(
      Translation2d wantedTranslation, Translation2d translation, double toleranceMeters) {
    return translation.getDistance(wantedTranslation) <= toleranceMeters;
  }

  public static boolean isNear(
      Translation2d wantedTranslation, Translation2d translation, Translation2d tolerance) {
  ...
  public static boolean isNearWrapped(
      Rotation2d wantedAngle, Rotation2d angle, Rotation2d tolerance) {
    return Math.abs(MathUtil.angleModulus(wantedAngle.minus(angle).getRadians()))
  ...
  public static Rotation2d clamp(Rotation2d angle, Rotation2d maxAngle) {
    return Rotation2d.fromRadians(
        MathUtil.clamp(angle.getRadians(), -maxAngle.getRadians(), maxAngle.getRadians()));
  }

  public static Rotation2d clamp(Rotation2d angle, Rotation2d minAngle, Rotation2d maxAngle) {
    return Rotation2d.fromRadians(
        MathUtil.clamp(angle.getRadians(), minAngle.getRadians(), maxAngle.getRadians()));
  }
}
