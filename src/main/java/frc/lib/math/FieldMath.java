...
public class FieldMath {
  ...
  public static Translation2d getRelativeTranslation(
      Translation2d relativeTo, Translation2d toRelative) {
  ...
  public static Translation2d getRelativeTranslation(Pose2d relativeTo, Translation2d toRelative) {
    return getRelativeTranslation(relativeTo.getTranslation(), toRelative)
        .rotateBy(relativeTo.getRotation().unaryMinus());
  }

  public static Translation2d getTranslationRelativeToZero(
      Pose2d relativeTo, Translation2d toRelative) {
  ...
  public static Pose2d mirror(
      Pose2d pose2d, boolean mirrorX, boolean mirrorY, AngleTransform angleTransform) {
    return new Pose2d(
        mirror(pose2d.getTranslation(), mirrorX, mirrorY),
        transformAngle(pose2d.getRotation(), angleTransform));
  }

  public static Translation3d mirror(
      Translation3d translation3d, boolean mirrorX, boolean mirrorY) {
  ...
  public static Translation2d mirror(
      Translation2d translation2d, boolean mirrorX, boolean mirrorY) {
    if (mirrorY) {
